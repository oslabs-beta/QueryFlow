...
<div class="w-full flex flex-col items-center content-center justify-center mt-6">
	...
	<button
		class="btn btn-primary m-1 border-primary hover:bg-secondary hover:text-white hover:border-secondary"
		on:click={() => {
	...
	<label
		for="my-drawer"
		class="btn btn-primary drawer-button border-primary hover:bg-secondary hover:text-white hover:border-secondary"
		>Add a query</label
	>
