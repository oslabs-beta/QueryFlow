<script lang="ts">
	...
	import ryan from '../assets/ryan_profile.avif';
	import niko from '../assets/niko_profile.avif';
	import philip from '../assets/philip_profile.avif';
	import { Carousel, Card, Modal, Avatar, Tooltip } from 'flowbite-svelte';
...
<main>
	<section class="landing-background object-cover w-full h-full inset-0">
		<div class="landing-background-text">
			...
			<button
				class="get-started btn btn-lg btn-primary drawer-button border-primary m-8 hover:bg-secondary hover:text-white hover:border-secondary font-semibold"
				on:click={() => navigate('/login')}>Get started</button
			>
		</div>
	</section>
		...
		<div class="flex justify-center">
			<div class="rounded p-6 top-column">
				...
				<h1 class="text-2xl font-medium">
					An NPM Package designed to automatically cache slow queries into a Redis database.
				</h1>
				<p class="pt-4">
					The NPM package incorporates QueryFlow.autoCache, an automatic caching feature for
					middleware and backend operations. This tool analyzes database queries and, if the
					execution time exceeds a set threshold, stores the results in a Redis cache database.
					Developers input the SQL and Redis models, the query string, variables and values, caching
					speed threshold, and TTL. This results in faster future queries, as data is swiftly
					retrieved from the cache. Regardless of data source, QueryFlow.autoCache delivers the
					queried results seamlessly into the middleware's response cycle.
				</p>
			</div>
		</div>
		<div class="flex justify-center">
			<div class="rounded p-6 top-column">
				...
				<h1 class="text-2xl font-medium">
					Use our powerful visualization tool to analyze and interpret slow PostgreSQL queries
				</h1>
				<p class="pt-4">
					QueryFlow is a tool designed to optimize the performance of PostgreSQL queries by mapping
					out planning, execution, and overall timing in comparison to other queries. It also
					provides a detailed table view showcasing shared, hit, and read blocks, facilitating the
					identification of performance deficiencies. Additionally, QueryFlow allows for
					comprehensive query comparisons and even offers a specific benchmarking feature against a
					Redis database. These capabilities make QueryFlow an essential tool for enhancing the
					performance of your PostgreSQL databases.
				</p>
			</div>
		</div>
	</section>
	...
	<section class="transition-container text-center flex items-center justify-center">
		<h1 class=" text-white text-4xl font-bold">
			Accelerating Your Database Queries, One Cache at a Time.
		</h1>
	</section>
	<section>
		<div class="grid justify-center mt-4 npm-package-container text-center">
			...
			<div
				class="mt-10 flex rounded-md bg-slate-600 text-slate-100 h-10 justify-between items-center npm-install"
			>
				...
				<button
					id="copyButton"
					class="btn btn-square btn-sm bg-transparent border-0 hover:bg-transparent p-0 mr-2"
				>
					<svg
	...
	<section
		class="text-4xl font-bold transition-container2 text-center flex items-center justify-center"
	>
	...
	<section
		class="text-4xl font-bold transition-container3 text-center flex items-center justify-center"
	>
	...
	<section
		class="text-4xl font-bold transition-container4 text-center flex items-center justify-center"
	>
		...
		<div class="grid md:grid-cols-2 sm:grid-cols-1 justify-center">
			...
			<div class="p-6">
				<h1 class="text-2xl xl:text-4xl font-bold">
					Explore your slow queries from various perspectives.
				</h1>

				<p class="mt-2 xl:text-lg">
					With the QueryFlow Visualizer, you have the flexibility to analyze your slow queries in a
					variety of ways. It enables you to juxtapose various SQL query strings using interactive
					graphs and detailed tables. This tool provides comprehensive visualization of execution
					time, planning time, and average time for all your queries, enhancing your understanding
					and aiding in optimization.
				</p>

				<h1 class="text-2xl xl:text-4xl font-bold mt-4">Side by side query comparisons</h1>
				<p class="mt-2 xl:text-lg">
					QueryFlow optimizes your SQL queries by offering performance comparisons and a global
					metrics chart for an overview of all your queries. Our standout feature, done with your
					consent, benchmarks your queries against Redis performance, showcasing caching benefits.
					You can leverage these insights using our NPM package, enabling seamless, dynamic caching
					for your application.
				</p>
				<div class="flex justify-center mt-4">
					<button class="btn btn-warning text-base" on:click={() => navigate('/login')}
						>Try it Today</button
					>
				</div>
			</div>
	...
	<section class="meet-team text-center">
		...
		<div class="grid grid-cols-5 gap-4 justify-around items-center h-60">
			<Card
				padding="sm"
				class="hover:shadow-lg hover:-translate-y-2 transition ease-in-out delay-200 bg-transparent border-none shadow-2xl"
			>
				<div class="flex flex-col items-center pb-4">
					...
					<div class="flex gap-2 mt-2">
						<a class="text-gray-100" href="https://github.com/ggreer91" target="_blank"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
								height="25"
						...
						<a
							class="text-gray-100"
							href="https://www.linkedin.com/in/george-greer/"
							target="_blank"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
			...
			<Card
				padding="sm"
				class="hover:shadow-lg hover:-translate-y-2 bg-transparent shadow-lg border-none shadow-2xl transition ease-in-out delay-200 "
			>
				<div class="flex flex-col items-center pb-4">
					...
					<span class="text-sm text-gray-100 dark:text-gray-400">Software Engineer</span>
					<div class="flex gap-2 mt-2">
						<a class="text-gray-100" href="https://github.com/vkpatel007" target="_blank"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
								height="25"
						...
						<a
							class="text-gray-100"
							href="https://www.linkedin.com/in/vivekpatel607"
							target="_blank"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
			...
			<Card
				padding="sm"
				class="hover:shadow-lg hover:-translate-y-2 bg-transparent border-none shadow-2xl transition ease-in-out delay-200 "
			>
				<div class="flex flex-col items-center pb-4">
					...
					<span class="text-sm text-gray-100 dark:text-gray-400">Software Engineer</span>
					<div class="flex gap-2 mt-2">
						<a class="text-gray-100" href="https://github.com/NikoAmescua" target="_blank"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
								height="25"
						...
						>
						<a class="text-gray-100" href="https://www.linkedin.com/in/nikoamescua" target="_blank"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
								height="25"
			...
			>
				<div class="flex flex-col items-center pb-4">
					...
					<span class="text-sm text-gray-100 dark:text-gray-400">Software Engineer</span>
					<div class="flex gap-2 mt-2">
						<a class="text-gray-100" href="https://github.com/cronullarc" target="_blank"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
								height="25"
						...
						<a
							class="text-gray-100"
							href="https://www.linkedin.com/in/ryancampbelladr/"
							target="_blank"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
			...
			>
				<div class="flex flex-col items-center pb-4">
					...
					<span class="text-sm text-gray-100 dark:text-gray-400">Software Engineer</span>
					<div class="flex gap-2 mt-2">
						<a class="text-gray-100" href="https://github.com/starfishpanda" target="_blank"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
								height="25"
						...
						<a
							class="text-gray-100"
							href="https://www.linkedin.com/in/philiplbrown/"
							target="_blank"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="25"
	...
	<section>
		<div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
			<span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center"
				>© 2023 <a href="https://www.query-flow.com">QueryFlow™</a>. All Rights Reserved.
				<p
					class="cursor-pointer text-gray-500 font-medium inline"
					on:keydown={() => {
						navigate('/privacy');
					}}
					on:click={() => {
			...
			<div class="flex mt-4 space-x-5 sm:justify-center md:mt-0">
				<a
					href="https://www.facebook.com/profile.php?id=100094996360163&is_tour_dismissed=true"
				...
				<a
					href="https://twitter.com/Query_Flow"
					class="text-gray-400 hover:text-gray-900 dark:hover:text-white"
				>
					<svg
						class="w-4 h-4"
