...
<!-- framework for login -->
<div style="height:100vh - 1px;" class="z-10 flex flex-col items-center justify-center px-6 pt-8 mx-9 mx-auto lg:py-0 max-w-96 login">
	<div
	...
	>
      ...
      {/if}
			...
			<button type="button" on:click={googleLogin} class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2 w-full justify-center">
